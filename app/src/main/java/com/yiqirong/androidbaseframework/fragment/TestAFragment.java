...
//                结束刷新
    ...
    public void onAttach(Context context) {
        ...
        LogUtils.e("Fragment     TestAFragment         onAttach");
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        LogUtils.e("Fragment     TestAFragment         onCreate");
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LogUtils.e("Fragment     TestAFragment         onCreateView");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        LogUtils.e("Fragment     TestAFragment         onActivityCreated");
    }

    @Override
    public void onStart() {
        super.onStart();
        LogUtils.e("Fragment    TestAFragment          onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        LogUtils.e("Fragment     TestAFragment         onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        LogUtils.e("Fragment      TestAFragment        onPause");
    ...
    public void onDestroy() {
        super.onDestroy();
        LogUtils.e("Fragment     TestAFragment         onDestroy");
    ...
    public void onDetach() {
        super.onDetach();
        LogUtils.e("Fragment     TestAFragment         onDetach");
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        LogUtils.e("Fragment     TestAFragment         setUserVisibleHint:"+isVisibleToUser);
    }
}
